...
<p>
Java-разработчик с 2+ годами практики, создающий backend-решения, которые действительно полезны людям. Автор Telegram-бота для бизнеса.
...
🔹 Вне кода:
Геймер, Спокойный и дружелюный, люблю гулять. Верю, что лучшие решения рождаются там, где пересекаются профессионализм и хорошая атмосфера в команде.
