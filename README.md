...
<p>
Java-разработчик с 2+ годами практики, создающий backend-решения, которые действительно полезны людям. Создал большое количество Telegram-ботов для бизнеса и их поддержку, которые по сей день успешно решают их проблемы и аатаматизируют рутину.
